...
export function HeroSection() {
  return (
    <section id="hero" className="relative px-4 pt-14 sm:px-6 lg:px-10">
      <div className="mx-auto grid w-full max-w-6xl items-center gap-12 rounded-[2rem] border border-[var(--card-border)] bg-[var(--card)] p-6 shadow-[0_0_80px_var(--overlay)] backdrop-blur-2xl sm:p-10 lg:grid-cols-[1.15fr_0.85fr] lg:p-14">
        <motion.div initial={{ opacity: 0, y: 25 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
          <p className="mb-6 inline-flex items-center gap-2 rounded-full border border-cyan-300/30 bg-cyan-400/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.24em] text-cyan-100">
          ...
          <div className="mt-9 flex flex-wrap gap-4">
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="group inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-cyan-400 via-blue-500 to-violet-500 px-6 py-3 text-sm font-semibold text-slate-950 shadow-[0_8px_32px_rgba(56,189,248,0.45)] transition"
            >
              Start Your Journey
        ...
        >
          <div className="absolute -inset-6 rounded-full bg-gradient-to-tr from-cyan-500/35 via-blue-500/20 to-fuchsia-400/30 blur-2xl" />
